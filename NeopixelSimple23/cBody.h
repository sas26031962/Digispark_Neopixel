...
public:
 ...
 // Методы
 //------------------------------------------------------------------------
 void born(int x, bool d, int p, int n);
 void move();
};
...
void cBody::born(int x, bool d, int p, int n)
{
...
void cBody::transform()
{
  ...
  switch(Phase)
  {
    ...
    case 10: 
      Pixel = cPixel(Value / DeviderHead, Value, Value);
      Pixel2 = cPixel(0, 0, 0);
      //if((Name == 1) &&(Head == NUMPIXELS / 2)) IsMobility = false; 
    break;
    case 11: 
      Pixel = cPixel(Value, Value / DeviderHead, Value);
      Pixel2 = cPixel(0, 0, 0); 
    break;
    case 12: 
      Pixel = cPixel(Value, Value, Value / DeviderHead);
      Pixel2 = cPixel(0, 0, 0); 
    break;
    case 13: 
      Pixel = cPixel(Value / DeviderHead, Value, Value);
